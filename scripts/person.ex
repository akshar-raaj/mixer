defmodule Person do
  ...
  def predict_income(age, city \\ "Hyderabad") do
  ...
  def predict_age_income(age) when is_number(age) and age <= 100 and age > 20 do
    case age do
  ...
  def predict_age_income(age) when is_number(age) and age < 20 do
    {:error, :minor}
  end

  def predict_age_income(age) when is_number(age) and age > 100 do
    {:error, :too_old}
  end
end
